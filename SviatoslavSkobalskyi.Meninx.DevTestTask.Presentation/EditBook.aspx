<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditBook.aspx.cs" Inherits="SviatoslavSkobalskyi.Meninx.DevTestTask.Presentation.EditBook" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            Edit Book<br />
            <br />
            Id<asp:TextBox ID="TB_ID" runat="server" ReadOnly="True"></asp:TextBox>
            <br />
